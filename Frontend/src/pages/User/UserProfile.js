...
const UserProfile = () => {
  ...
  return (
    <Box sx={{ marginLeft:-2, position: 'relative', minHeight: '100vh', backgroundColor: isDarkTheme ? '#333' : '#f0f0f0', color: isDarkTheme ? '#fff' : '#000', p: 3 }}>
          ...
          <CardContent>
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 2 }}>
              <Box sx={{ position: 'relative' }}>
                <Avatar src={profile.profilePicture} sx={{ width: 120, height: 120, border: `3px solid ${isDarkTheme ? '#fff' : '#000'}` }} />
                <input
                  accept="image/*"
                  style={{ display: 'none' }}
